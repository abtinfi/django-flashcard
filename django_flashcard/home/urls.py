...
urlpatterns = [
    ...
    path("flashcard/<int:card_id>", views.ShowAnswerFlashcard.as_view(), name="show_card"),
    ...
    path('flashcards/<int:pk>/review/', views.FlashCardReviewView.as_view(), name='review_flashcard'),
